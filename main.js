...
function loadURL(url) {
  if (url === '#main')
    loadPage('index', null, null)
  else if (url === '#guard-items')
    loadPage('items', 'Zadania', 'guard-items?ajax=yes')
  else if (url === '#service-items')
    loadPage('items', 'Usługi', 'service-items?ajax=yes')
  else if (url === '#warn-items')
    loadPage('items', 'Błędy i ostrzeżenia', 'log-items?status=warn&ajax=yes')
  else if (url === '#log-items')
    loadPage('items', 'Dzienniki', 'log-items?ajax=yes')
  else if (url === '#server-items')
    loadPage('servers', 'Serwery', null)
  else if (url === '#about')
    showAbout()
  else
